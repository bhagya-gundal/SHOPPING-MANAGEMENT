...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 340, -1, -1));
        jPanel5.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(132, 149, -1, 168));
        ...
        userNameJTextField.setForeground(new java.awt.Color(0, 77, 64));
        ...
        jPanel6.add(userNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 180, 310, 50));
        ...
        jPanel6.add(passwordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, 310, 50));
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        ...
        if (userAccount == null) {
            ...
            cardParentPanel.add("workArea", userAccount.getRole().createWorkArea(cardParentPanel, userAccount, inOrganization, inEnterprise, system));
            layout.next(cardParentPanel);
        }
    ...
    private void populateTable() {
        ArrayList<Enterprise> enterpriseList = system.getNetworkList().get(0).getEnterpriseDirectory().getEnterpriseList();
        Enterprise vendorEnterprise = enterpriseList.stream().filter(enterprise -> enterprise.getEnterpriseType() == Enterprise.EnterpriseType.Vendor).findAny()
                .orElse(null);
        Organization organization = vendorEnterprise.getOrganizationDirectory().getOrganizationList().stream().filter(org -> org.getName().equals("Inventory Organization")).findAny().orElse(null);
        ...
        Display(homeTable, NewlyAddedProducts);
    ...
    private void SetProductCatgeoryAndVendorName(ArrayList<Employee> employees) {
        for (Employee employee : employees) {
    ...
    private void Display(JTable homeTable, ArrayList<Product> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String path = Paths.get("/products/electronics/" + temp).toString();
